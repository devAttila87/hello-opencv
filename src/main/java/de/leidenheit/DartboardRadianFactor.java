 ...
 * Dartsboard of the PDC have a size of 451mm, including the outer black part.
 * In order to determine the radians a detected most outer ellipse should be considered 
 * for applying the following relative factors:
 * 
